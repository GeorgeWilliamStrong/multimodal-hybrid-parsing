...
def test_pdf_parsing():
    ...
    # Create a parser instance with GPT-4o-mini for image description
    ...
    output_dir = Path("tests/output/markdown/heuristic_cuda_gpt4omini")
    output_dir.mkdir(parents=True, exist_ok=True)

    # Create timing stats directory
    stats_dir = Path("tests/stats")
    stats_dir.mkdir(parents=True, exist_ok=True)
    benchmark_file = stats_dir / "heuristic_parsing_cuda_gpt4omini_stats.json"
